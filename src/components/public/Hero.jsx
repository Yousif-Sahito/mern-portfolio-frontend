...
import { useEffect, useMemo, useState } from "react";
import yousifImg from "../../assets/yousif.png"; // ✅ adjust if needed
      ...
      <div className="container-page">
        <div className="card p-8 md:p-10">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            {/* LEFT SIDE */}
            <div>
              <h1 className="text-4xl md:text-5xl font-bold">Yousif Ahmed</h1>
              ...
              {/* ROLE INFO */}
              <div className="mt-5 border border-zinc-800 rounded-2xl p-5">
                <h3 className="text-xl font-semibold">{activeRole.headline}</h3>
                {activeRole.lines.map((l, i) => (
                  <p key={i} className="opacity-80 mt-1">
                    {l}
                  </p>
